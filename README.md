...
با اعمال محدودیت روی شاخه‌ی main نمی‌توان به طور مستقیم روی آن کامیت کرد و با ساختن یک برنچ جدید و کامیت و پوش کردن روی آن، در صفحه‌ی ریپو پاپ‌اپی با عنوان compare and pull request ظاهر می‌شود و با انتخاب آن دکمه می‌توانیم تغییراتی که این شاخه با شاخه‌ی main دارد را مقایسه کنیم و در نهایت pull request را ایجاد کنیم. بعد از ایجاد پول ریکوئست فردی به عنوان reviewer باید آن را تایید کند و پس از approve شدن پول ریکوئست می‌توانیم آن را با شاخه‌ی اصلی مرج کنیم.
![Screenshot from 2024-07-06 12-26-58](https://github.com/Fonij80/SELab_HW1/assets/173658851/7a8dce6f-eb96-4e63-8276-280e046ffa29)
![Screenshot from 2024-07-06 12-27-46](https://github.com/Fonij80/SELab_HW1/assets/173658851/53597c15-f7ad-4262-b59e-7a953d0a5057)
...
۳. انتخاب Deploy from a branch به عنوان source

۴. انتخاب شاخه‌ی gh-pages به عنوان شاخه‌ای که قرار است در آدرسی که در homepage فایل package.json مشخص شده است، پابلیش شود.

* [Our Published Page](https://fonij80.github.io/SELab_HW1/)
...
جواب:         دستور fetch تنها برنچ های remote-tracking را آپدیت می‌کند و ادغامی (merge) انجام نمی‌دهد.</br>
        ...
        که در مقابل cherry-pick برای اعمال برخی commit های خاص (بدون ادغام کل برنچ) استفاده می‌شود.<br>
...
جواب:         دستور reset برای تغییر برنچ و حذف تغییرات به کار می‌رود(تاریخچه را تغییر میدهد).</br>
        ...
        دستور switch تنها برای تغییر برنچ ‌ها استفاده می‌شود، در حالی که دستور checkout می‌تواند هم برای تغییر برنچ ها و هم برای بازگرداندن فایل‌ها به یک commit مشخص شده استفاده شود.<br>
